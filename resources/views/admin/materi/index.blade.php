    ...
    <div class="bg-white rounded-2xl shadow-xl w-full max-w-md p-6">
        ...
        <form id="modalForm" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-4">
                ...
                <select name="modul_id" id="fModul" required class="w-full rounded-xl border border-stone-200 px-4 py-2.5 outline-none focus:border-emerald-400 focus:ring-2 focus:ring-emerald-200">
                    @foreach ($modul as $md)
            ...
            <div class="mb-4">
                <label class="block text-sm font-semibold text-stone-600 mb-1">Jenis Konten</label>
                <select name="tipe_konten" id="fTipe" onchange="toggleTipe()" class="w-full rounded-xl border border-stone-200 px-4 py-2.5 outline-none focus:border-emerald-400 focus:ring-2 focus:ring-emerald-200">
                    <option value="teks">Teks Arab (huruf)</option>
                    <option value="gambar">Gambar</option>
                </select>
            </div>

            <div id="boxTeks" class="mb-4">
                <label class="block text-sm font-semibold text-stone-600 mb-1">Huruf / Teks Arab</label>
                <input type="text" name="teks_arab" id="fTeks" dir="rtl"
                    class="font-arabic text-2xl w-full rounded-xl border border-stone-200 px-4 py-2.5 outline-none focus:border-emerald-400 focus:ring-2 focus:ring-emerald-200">
            </div>
            ...
            <div class="mb-4">
                <label class="block text-sm font-semibold text-stone-600 mb-1">Label (nama bacaan)</label>
                <input type="text" name="label" id="fLabel" required placeholder="contoh: Ba"
            ...
            <div class="mb-5">
                ...
                <input type="number" name="urutan" id="fUrutan" value="0" class="w-full rounded-xl border border-stone-200 px-4 py-2.5 outline-none focus:border-emerald-400 focus:ring-2 focus:ring-emerald-200">
            </div>
...
<script>
    ...
    const storeUrl = "{{ route('admin.materi.store') }}";
    const baseUrl = "{{ url('admin/materi') }}";

    function toggleTipe() {
        const tipe = document.getElementById('fTipe').value;
        document.getElementById('boxTeks').classList.toggle('hidden', tipe !== 'teks');
    ...
    function editMateri(btn) { bukaModal(btn.dataset); }
    function tutupModal() {
